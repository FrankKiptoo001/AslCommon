// table 61724 "PROC-Store Requistion Lines"
// {
...
//                     IF ((QtyStore.Inventory <= 0)) THEN ERROR('There are no  ''' + QtyStore.Description + '''  on stock.');
...
//                 IF "Quantity Requested" > "Qty in store" THEN ERROR('You can not request more than in store');
